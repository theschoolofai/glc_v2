"""Mock-API fake for the Gemini Live TTS (BidiGenerateContent WebSocket) TTS provider.
...
class GeminiLiveMock:
    ...
    setup_response_modalities: list[str] | None = None
    ...
    async def synthesize(self, text: str, voice_id: str | None = None) -> SynthesizeResult:
        ...
        # The behavioural test asserts the adapter sent a setup frame with
        # responseModalities=['AUDIO']. The adapter records frames via
        # record_frame() below.
        pass

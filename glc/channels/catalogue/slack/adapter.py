"""Stub adapter for Slack Events API.

Group assignment: implement on_message and send against the mock-API
fake in tests/channels/mocks/slack_mock.py. See docs/ADAPTER_GUIDE.md
...
class Adapter(ChannelAdapter):
    ...
    async def on_message(self, raw: Any) -> ChannelMessage:
        raise NotImplementedError(
            ...
            "See docs/ADAPTER_GUIDE.md and glc/channels/catalogue/slack/README.md."
        )
